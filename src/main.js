...
function details(event) {
  ...
  const redditField = event.category === 'reddit' ? `<label>Reddit profile URL<input required type="url" name="reddit_url" placeholder="https://www.reddit.com/user/your-name"/></label><button class="reddit-profile-help" id="reddit-profile-help" type="button">How do I get my Reddit profile link?</button>` : ''
